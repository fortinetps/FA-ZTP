...
def generate_fortigate_var_files(sheets=None):
    ...
    for fgt in sheets['FortiGates']:
        fgt_dict = {
            ...
            'fortilink_interfaces_from_vsw': str(fgt['FortiLink Interfaces From VSW']).lower(),
            'fortilink_stack_ip': fgt['FortiLink Stack IP'],
            'fortilink_split_interface': fgt['FortiLink Split Interface'],
            'fortilink_auto_authorize': fgt['FortiLink Auto Authorize'],
